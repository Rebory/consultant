...
<li class="active"><a href="#edit" data-toggle="tab">Categories</a></li>
</ul>
...
<tr>
<a class="btn btn-theme btn-sm pull-right" href="{{ route('categories.create') }}">Add New</a>
<th>Category Name</th>
